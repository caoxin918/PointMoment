...
def train(args, io):
    ...
    wandb.init(project="PointMoment_seg_finetune_music", name=args.exp_name)
    wandb.watch(model)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', type=str, default='exp_seg_down_1', metavar='N',
    ...
    parser.add_argument('--pretrained_path', type=str, default='../exp_music/seg/model_best.pth', metavar='N',
                        help='Pretrained model path')
