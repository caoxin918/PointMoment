...
def get_arguments():
    ...
    # Checkpoints
    parser.add_argument("--exp-dir", type=Path, default="../exp/home_modelnet40_mlp_4096_512_batchsize_48_epoch_60_augument_strl(strl_utils)_pointnet_opt_adam_lr_0.001_CosineAnnealingLR_v27",
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        wandb.log({"loss":train_losses.avg})
